  ...
  perSystem =
    ...
    let
      ...
      modelStateAssetsDir = pkgs.runCommand "models-state-assets" { } ''
        mkdir -p "$out"
        cp ${../../modules/terminal/opencode/models.json} "$out/models.json"
        cp ${../../modules/terminal/opencode/state.json} "$out/state.json"
        cp ${../../modules/terminal/opencode/presets.json} "$out/presets.json"
        cp ${../../modules/terminal/opencode/_model-local-patches.json} "$out/_model-local-patches.json"
        cp ${../../modules/terminal/opencode/provider.json} "$out/provider.json"
      '';
