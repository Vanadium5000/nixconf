...
}:
{
  perSystem =
    ...
    in
    {
      packages.qs-passmenu = inputs.wrappers.lib.wrapPackage {
        inherit pkgs;
      ...
      packages.qs-checklist = inputs.wrappers.lib.wrapPackage {
        inherit pkgs;
      ...
      packages.btrfs-backup = inputs.wrappers.lib.wrapPackage {
        inherit pkgs;
      ...
      packages.qs-music-search = inputs.wrappers.lib.wrapPackage {
        inherit pkgs;
      ...
      packages.qs-music-local = inputs.wrappers.lib.wrapPackage {
        inherit pkgs;
      ...
      packages.pomodoro = inputs.wrappers.lib.wrapPackage {
        inherit pkgs;
      ...
      packages.image-gen-mcp = inputs.wrappers.lib.wrapPackage {
        inherit pkgs;
      ...
      packages.markdown-lint-mcp = inputs.wrappers.lib.wrapPackage {
        inherit pkgs;
      ...
      packages.qmllint-mcp = inputs.wrappers.lib.wrapPackage {
        inherit pkgs;
      ...
      packages.git-sync-debug = inputs.wrappers.lib.wrapPackage {
        inherit pkgs;
      ...
      packages.bunjs-scripts = pkgs.symlinkJoin {
        name = "bunjs-scripts";
        paths = [
          self'.packages.btrfs-backup
          self'.packages.git-sync-debug
          self'.packages.http-proxy
          self'.packages.image-gen-mcp
          self'.packages.markdown-lint-mcp
          self'.packages.playwright-stealth-browser
          self'.packages.pomodoro
          self'.packages.qmllint-mcp
          self'.packages.qs-checklist
          self'.packages.qs-music-local
          self'.packages.qs-music-search
          self'.packages.qs-passmenu
          self'.packages.synced-lyrics
          self'.packages.vpn-proxy
          self'.packages.vpn-proxy-cleanup
          self'.packages.vpn-proxy-netns
          self'.packages.vpn-proxy-singbox-config
          self'.packages.vpn-proxy-web
          self'.packages.vpn-resolver
        ];
        meta = {
          description = "Bundled Bun/TypeScript scripts and CLI wrappers from this flake";
