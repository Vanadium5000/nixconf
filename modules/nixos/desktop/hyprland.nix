    ...
    in
    {
      ...
      home.programs.hyprland.settings = {
        ...
        general = {
          ...
          "col.active_border" = lib.mkForce "rgb(${colorsNoHash.border-color})";
          "col.inactive_border" = lib.mkForce "rgb(${colorsNoHash.border-color-inactive})";
        };

        group = {
          groupbar = {
            "col.active" = lib.mkForce "rgb(${colorsNoHash.border-color})";
            "col.inactive" = lib.mkForce "rgb(${colorsNoHash.border-color-inactive})";
          };
          "col.border_active" = lib.mkForce "rgb(${colorsNoHash.border-color})";
          "col.border_inactive" = lib.mkForce "rgb(${colorsNoHash.border-color-inactive})";
        };
