...
let
  ...
  categories = {
    "visual-engineering" = {
      ...
      defaultModel = "router/gemini-3.1-pro-high";
    };
    ultrabrain = {
      label = "Ultrabrain";
      description = "Hard logic, architecture, and deep debugging tasks";
      defaultModel = "router/gpt-5.4";
    };
    deep = {
      label = "Deep";
    ...
    quick = {
      ...
      defaultModel = "router/gemini-3-flash";
    };
    writing = {
      label = "Writing";
...
in
{
  ...
  mkMenuMetadata = {
    menu = {
      ...
      providerAction = "🌐 General: Switch Router Provider";
      ...
      presetNamePrompt = "🏷️ Model-group preset name";
      presetManagerHeader = "📚 Select model-group preset";
      presetActionHeader = "🛠️ Model-group preset action";
