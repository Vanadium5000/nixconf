  ...
  flake.nixosModules.obsidian =
    ...
    in
    {
      ...
      config = mkIf cfg.enable {
        ...
        # Obsidian is unfree; the central policy records the rationale while
        # this feature keeps the allowance opt-in instead of fleet-wide.
        preferences.allowedUnfree = self.lib.nixpkgs.allowedUnfreeFor "modules/desktop/obsidian.nix";
