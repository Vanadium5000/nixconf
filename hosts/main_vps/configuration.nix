  ...
  flake.nixosModules.main_vpsHost =
    ...
    }:
    {
      ...
      services.omniroute = {
        ...
        initialPassword = self.secrets.OMNIROUTE_INITIAL_PASSWORD;
      ...
      # Keep the server identity stable across root rotations; OpenSSH regenerates
      # missing host keys during boot, breaking every client trust relationship.
